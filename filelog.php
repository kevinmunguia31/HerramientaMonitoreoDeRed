...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <div class="container mt-4">
        <hr>
        <?php
            $filename = $_POST['logname'];
            $maquina = $_POST['maquina'];
            //echo $maquina . $filename;
            echo "<h4>Registro de archivo " . "<b>" . $filename . "</b>" . " de la maquina " . "<b>" . $maquina . "</b>" . "</h4>";
            $comando = 'cat /var/log/remote/';

            $sentencia = $comando . $maquina . "/" . $filename;
            //echo $sentencia;
