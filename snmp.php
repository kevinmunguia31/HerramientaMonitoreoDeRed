...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <div class="container mt-4">
        <form action="/snmp.php" method="post" name="formulario">
            <label for="">Introduzca la IP</label>
            <input type="text" name="txtIp" id="">
            <label for="">Introduzca la Comunidad</label>
            <input type="text" name="txtComunidad" id="">
            <div class="input-group mb-3 w-50">
                ...
                <select class="custom-select" name="parametro" id="inputGroupSelect01">
                    <option value="sysDescr.0">Sistema</option>
                    <option value="ifNumber.0">Numero de Interfaces</option>
                    <option value=".1.3.6.1.2.1.1.3.0">Tiempo de Encendido</option>
                    <option value="sysName.0">Nombre de la Maquina</option>
    ...
    <div class="container mt-4">
        ...
        <?php
            ...
            $comando = "snmpget -v1 -c ";

            $sentencia = $comando . $comunidad . " " . $ip . " " .  $opcion;
            //echo $sentencia;
